...
import sys
sys.path.append('C:/CARLA_0.9.12/PythonAPI/carla/dist/carla-0.9.12-py3.7-win-amd64.egg')
sys.path.append('C:/CARLA_0.9.12/PythonAPI/carla/agents')
sys.path.append('C:/CARLA_0.9.12/PythonAPI/carla')


# rest of the sinadra_risk_sensor_client.py script
